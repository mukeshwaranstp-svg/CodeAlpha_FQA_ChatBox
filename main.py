...
try:
    ...
    print("customtkinter package not found. Installing via pip...")
...
class MugiwaraFAQBot(ctk.CTk):
    def __init__(self) -> None:
        ...
        self._title_font = ctk.CTkFont(family="Segoe UI", size=16, weight="bold")
        self._subtitle_font = ctk.CTkFont(family="Segoe UI", size=10)
        self._msg_font = ctk.CTkFont(family="Segoe UI", size=11)
        self._time_font = ctk.CTkFont(family="Segoe UI", size=8)
        self._btn_font = ctk.CTkFont(family="Segoe UI", size=10)
        self._dot_font = ctk.CTkFont(family="Segoe UI", size=10)
    ...
    def _build_header(self, parent: ctk.CTkFrame) -> None:
        ...
        # Right-side controls (theme toggle and clear chat)
        right_block = ctk.CTkFrame(header, fg_color=SECONDARY, corner_radius=0)
        right_block.grid(row=0, column=1, sticky="e", padx=20, pady=12)

        current_mode = ctk.get_appearance_mode()
        theme_text = "Switch to Light" if current_mode == "dark" else "Switch to Dark"
    ...
    def _toggle_theme(self) -> None:
        ...
        btn_text = "Switch to Light" if new_mode == "dark" else "Switch to Dark"
        try:
